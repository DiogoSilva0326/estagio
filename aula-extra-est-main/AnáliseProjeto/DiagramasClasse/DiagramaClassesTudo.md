...
direction TB
	...
	class Professor_Feedback {
	    PK id_Professor_Feedback INT NOT NULL
	...
	class Wishlist {
	    PK id_Wishlist INT NOT NULL
	    FK id_User INT NOT NULL
	    DATETIME created_at
	}
	class WishlistItem {
	    PK id_WishlistItem INT NOT NULL
	    FK id_Wishlist INT NOT NULL
	    FK course_Id INT 
		FK id_Professor INT
	    DATETIME added_at
	}
	...
	class Lesson_FeedBack {
	    PK id_Lesson_Feedback INT NOT NULL
    ...
    class Reservation {
	    ...
	    FK id_BlockPart INT
		INT min_students_at_booking %% default 1
	    DATETIME start_time
	    DATETIME end_time
	...
	PaymentMethod "*" -- "1" User : owner
	CommissionRule "*" -- "1" Professor
	CommissionRule "0..1" -- "*" ReservationPayment : applies_to
	Lesson "1" -- "*" Lesson_FeedBack : receives
	Professor "1" -- "*" Professor_Feedback : receives
	Wishlist "1" -- "*" WishlistItem : contains
	User "1" -- "0..1" Wishlist : may_have
	WishlistItem "*" -- "0..1" Course : for_course
	WishlistItem "*" -- "0..1" Professor : for_professor
	ExceptionRequest "0..1" -- "1" ExceptionRule : creates
	...
	class Professor_Feedback:::Sky
	class Lesson_FeedBack:::Class_02
	class Wishlist:::Ash
	class WishlistItem:::Ash
