namespace AgoraBackend.agoraAPI.Utils;
...
/// <summary>
/// Vendored AccessToken2 generator for Agora RTM.
...
public class AccessToken2
{
    ...
    private const byte VersionLength = 1;
    private const byte ExtensionLength = 2;
