...
import '../widgets/professional_directory_notice_card.dart';
import 'explicadores_header_section.dart';
import 'explicadores_table_section.dart';

class ExplicadoresOverviewSection extends StatefulWidget {
  const ExplicadoresOverviewSection({super.key});

  @override
  State<ExplicadoresOverviewSection> createState() =>
      _ExplicadoresOverviewSectionState();
}

class _ExplicadoresOverviewSectionState
    extends State<ExplicadoresOverviewSection> {
  ...
  Future<BackofficeProfessionalsViewData> _load() {
    return BackofficeProfessionalsService().fetch(
      BackofficeProfessionalCategory.explicadores,
    );
  }
