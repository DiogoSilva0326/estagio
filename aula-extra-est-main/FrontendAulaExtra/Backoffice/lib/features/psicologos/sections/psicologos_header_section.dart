...
class PsicologosHeaderSection extends StatelessWidget {
  const PsicologosHeaderSection({
    super.key,
      ...
      builder: (context, constraints) {
          ...
          return Column(
            ...
            children: [
              ...
              const Align(
                ...
                child: ExplicadoresAddButton(label: 'Adicionar Psicólogo'),
              ),
            ],
          );
        }
        ...
        return Row(
          ...
          children: [
            ...
            const ExplicadoresAddButton(label: 'Adicionar Psicólogo'),
          ],
        );
      },
    );
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        Text(
          'Gestão de perfis e aprovações de psicólogos.',
          style: TextStyle(
