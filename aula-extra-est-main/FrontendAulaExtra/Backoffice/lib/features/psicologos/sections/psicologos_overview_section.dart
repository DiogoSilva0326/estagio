...
import 'psicologos_header_section.dart';
import 'psicologos_table_section.dart';

class PsicologosOverviewSection extends StatefulWidget {
  const PsicologosOverviewSection({super.key});

  @override
  State<PsicologosOverviewSection> createState() =>
      _PsicologosOverviewSectionState();
}

class _PsicologosOverviewSectionState extends State<PsicologosOverviewSection> {
  ...
  Future<BackofficeProfessionalsViewData> _load() {
    return BackofficeProfessionalsService().fetch(
      BackofficeProfessionalCategory.psicologos,
    );
  }
