...
import 'package:aula_extra/features/aluno/calendario/sections/calendario_semanal_content_section.dart';
import 'package:aula_extra/routes/routes.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class CalendarioSemanalScreen extends StatelessWidget {
  const CalendarioSemanalScreen({super.key});
              ...
              children: const [
                ColoredBox(
                  ...
                  child: SizedBox(
                    ...
                    child: FullBleedScaledSection(child: CalendarioSemanalContentSection()),
                  ),
                ),
                ColoredBox(
                  color: Color(0xFFF9F9F9),
