        ...
        child: Column(
          children: [
            ...
            Column(
              children: [
                _LabelValueRow(
                  label: 'Última ${singularTerm.toLowerCase()}:', 
...
class _SubjectsDropdownButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<String>(
      tooltip: 'Ver restantes serviços',
      itemBuilder: (context) => [
...
class _Avatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inner = outer - borderWidth * 2 - 2;
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Icon(Icons.calendar_today, size: 22.062, color: Colors.white),
                  const SizedBox(height: 5.515),
                  Text(
                    'Marcar', 
                    style: const TextStyle(
