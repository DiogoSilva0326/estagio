...
class MeusExplicadoresMobileTutorCard extends StatelessWidget {
  ...
  final TeachingRoleConfig roleConfig;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        // COR DINÂMICA: Borda do cartão ganha a cor da role
        border: Border.all(color: roleConfig.primaryColor, width: 2.3),
        boxShadow: const [
          BoxShadow(
      ...
      child: Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        // COR DINÂMICA: Fundo da disciplina principal
          ...
          Row(
            children: [
              Text(
                'Última ${singularTerm.toLowerCase()}:',
                style: const TextStyle(
                  fontSize: 14,
                  height: 1.4,
          ...
          Row(
            children: [
              ...
              Icon(
                Icons.star_rounded,
                size: 18,
                // COR DINÂMICA: Ícone de estrela usa a cor acento da role (ou manténs fixo a amarelo, se preferires, mas aqui sigo o pedido)
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              // COR DINÂMICA: Barra de progresso usa a cor primária da role
              valueColor: AlwaysStoppedAnimation<Color>(roleConfig.primaryColor),
            ),
          ),
          const SizedBox(height: 16),
          Wrap(
            ...
            children: [
              for (final subject in visibleSubjects)
                Container(
                  ...
                  decoration: BoxDecoration(
                    // COR DINÂMICA: Fundo das bolhas de disciplinas extra
                    color: roleConfig.primaryLight,
                    borderRadius: BorderRadius.circular(999),
                  ),
                  child: Text(
                    subject,
                    style: TextStyle(
                      ...
                      // COR DINÂMICA: Texto das disciplinas extra
                      color: roleConfig.primaryDark,
                    ),
                  ),
                ),
            ],
          ...
          Row(
            children: [
              Expanded(
                child: DecoratedBox(
                  decoration: BoxDecoration(
                    // COR DINÂMICA: Botão de Ver Perfil
                    color: roleConfig.primaryColor,
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                minimumSize: const Size.fromHeight(46),
                // COR DINÂMICA: Contorno do botão de marcar sessão
                side: BorderSide(color: roleConfig.borderColor),
                // COR DINÂMICA: Cor do ícone e texto
                foregroundColor: roleConfig.primaryColor,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(14),
                ),
              ),
