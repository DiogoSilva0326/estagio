...
class MeusTutoresScreen extends StatelessWidget {
  const MeusTutoresScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final contentSection = const MeusProfissionaisContentSection(
      title: 'Meus Tutores',
      subtitle: 'Veja os seus tutores preferidos e faça a gestão do seu acompanhamento.',
      emptyStateTitle: 'Ainda não tem tutores',
      emptyStateMessage: 'Explore mais tutores e comece a construir a sua rede de apoio ao estudo.',
      findMoreLabel: 'Encontrar tutores',
      targetRole: 'Tutor',
      findMoreRoute: Routes.tutores, 
    );
