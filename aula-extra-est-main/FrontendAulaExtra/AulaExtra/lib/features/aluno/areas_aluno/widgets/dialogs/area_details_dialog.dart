      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            child: Text(
              tutor.name.isNotEmpty ? tutor.name.characters.first.toUpperCase() : 'E',
              style: const TextStyle(
                fontSize: 18,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.star_rounded, size: 16, color: Color(0xFFFC9039)),
                    ...
                    const Icon(Icons.menu_book_outlined, size: 16, color: Color(0xFF6A7282)),
                    const SizedBox(width: 4),
                    Text(
