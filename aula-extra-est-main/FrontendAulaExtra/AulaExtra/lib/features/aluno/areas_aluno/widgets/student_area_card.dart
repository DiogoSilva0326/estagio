...
class StudentAreaCard extends StatelessWidget {
  const StudentAreaCard({
    super.key,
  ...
  bool _isSessao(String role, String name) {
    if (role.trim().isNotEmpty && role.toLowerCase() != 'ensino') return true;
  ...
  Widget build(BuildContext context) {
    final title = disciplina.nome.trim().isEmpty ? 'Serviço / Apoio' : disciplina.nome.trim();
    
    final isSessao = _isSessao(targetRole, areaName);
