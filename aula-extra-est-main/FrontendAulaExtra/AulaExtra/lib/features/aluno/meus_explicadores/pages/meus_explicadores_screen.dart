...
import 'package:aula_extra/features/aluno/meus_explicadores/sections/meus_explicadores_content_section.dart';
import 'package:aula_extra/features/aluno/areas_aluno/widgets/full_bleed_scaled_section.dart';
import 'package:aula_extra/routes/routes.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class MeusExplicadoresScreen extends StatelessWidget {
  const MeusExplicadoresScreen({super.key});
              ...
              children: const [
                ColoredBox(
                  ...
                  child: SizedBox(
                    ...
                    child: FullBleedScaledSection(child: MeusExplicadoresContentSection()),
                  ),
                ),
                ColoredBox(
                  color: Color(0xFFF9F9F9),
