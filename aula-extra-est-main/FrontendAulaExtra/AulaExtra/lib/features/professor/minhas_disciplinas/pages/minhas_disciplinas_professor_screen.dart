...
import 'package:aula_extra/features/professor/minhas_disciplinas/pages/minhas_disciplinas_professor_mobile_page.dart';
...
class MinhasDisciplinasProfessorScreen extends StatelessWidget {
  const MinhasDisciplinasProfessorScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (isMobile) {
      return const MinhasDisciplinasProfessorMobilePage();
    }
      ...
      body: CustomScrollView(
        slivers: [
          ...
          const SliverToBoxAdapter(
            child: MinhasDisciplinasProfessorContentSection(),
          ),
