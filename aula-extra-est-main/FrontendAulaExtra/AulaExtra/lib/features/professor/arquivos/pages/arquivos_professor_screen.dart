...
import 'package:aula_extra/features/professor/arquivos/pages/arquivos_professor_mobile_page.dart';
...
class ArquivosProfessorScreen extends StatelessWidget {
  const ArquivosProfessorScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (isMobile) {
      return const ArquivosProfessorMobilePage();
    }
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          ...
          const SliverToBoxAdapter(child: ArquivosProfessorContentSection()),
