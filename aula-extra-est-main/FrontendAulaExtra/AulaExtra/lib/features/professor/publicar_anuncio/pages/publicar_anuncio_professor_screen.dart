...
import 'package:aula_extra/features/professor/publicar_anuncio/pages/publicar_anuncio_professor_mobile_page.dart';
...
class PublicarAnuncioProfessorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isMobile) {
      return PublicarAnuncioProfessorMobilePage(initialAd: args?.ad);
    }
