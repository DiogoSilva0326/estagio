...
import 'package:aula_extra/features/professor/perfil/pages/perfil_professor_mobile_page.dart';
...
class PerfilProfessorScreen extends StatelessWidget {
  const PerfilProfessorScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (isMobile) {
      return const PerfilProfessorMobilePage();
    }
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          ...
          const SliverToBoxAdapter(child: PerfilProfessorContentSection()),
