...
namespace ConfidantPostgreSQL.Modules.Payments.Service
{
    public interface IPaymentsService
    {
        ...
        Task<ProfessorPaymentSummaryDto> GetProfessorPaymentSummaryAsync(Guid idUser);
        ...
        Task<StudentPaymentSummaryDto> SimulateStudentTopupAsync(Guid idUser, StudentTopupSimulationRequest request);
